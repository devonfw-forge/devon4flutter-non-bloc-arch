 ...
 */
@Entity
@javax.persistence.Table(name = "EmployeeListRequestDtoSchema")
public class EmployeeListRequestDtoSchemaEntity extends ApplicationPersistenceEntity implements EmployeeListRequestDtoSchema {
